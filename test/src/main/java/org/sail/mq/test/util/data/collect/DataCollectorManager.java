...
package org.sail.mq.test.util.data.collect;

import java.util.HashMap;
import java.util.Map;
import org.sail.mq.test.util.data.collect.impl.ListDataCollectorImpl;
import org.sail.mq.test.util.data.collect.impl.MapDataCollectorImpl;
