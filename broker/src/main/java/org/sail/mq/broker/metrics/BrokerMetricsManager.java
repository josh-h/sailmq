...
import org.sail.mq.common.metrics.NopObservableLongGauge;
...
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.AGGREGATION_DELTA;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.COUNTER_COMMIT_MESSAGES_TOTAL;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.COUNTER_CONSUMER_SEND_TO_DLQ_MESSAGES_TOTAL;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.COUNTER_MESSAGES_IN_TOTAL;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.COUNTER_MESSAGES_OUT_TOTAL;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.COUNTER_ROLLBACK_MESSAGES_TOTAL;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.COUNTER_THROUGHPUT_IN_TOTAL;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.COUNTER_THROUGHPUT_OUT_TOTAL;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.GAUGE_TOPIC_NUM;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.GAUGE_CONSUMER_GROUP_NUM;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.GAUGE_BROKER_PERMISSION;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.GAUGE_CONSUMER_CONNECTIONS;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.GAUGE_CONSUMER_INFLIGHT_MESSAGES;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.GAUGE_CONSUMER_LAG_LATENCY;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.GAUGE_CONSUMER_LAG_MESSAGES;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.GAUGE_CONSUMER_QUEUEING_LATENCY;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.GAUGE_CONSUMER_READY_MESSAGES;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.GAUGE_HALF_MESSAGES;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.GAUGE_PROCESSOR_WATERMARK;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.GAUGE_PRODUCER_CONNECTIONS;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.HISTOGRAM_FINISH_MSG_LATENCY;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.HISTOGRAM_MESSAGE_SIZE;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.HISTOGRAM_TOPIC_CREATE_EXECUTE_TIME;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.HISTOGRAM_CONSUMER_GROUP_CREATE_EXECUTE_TIME;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.LABEL_AGGREGATION;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.LABEL_CLUSTER_NAME;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.LABEL_CONSUMER_GROUP;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.LABEL_CONSUME_MODE;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.LABEL_IS_RETRY;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.LABEL_IS_SYSTEM;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.LABEL_LANGUAGE;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.LABEL_NODE_ID;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.LABEL_NODE_TYPE;
import static org.sail.mq.broker.metrics.BrokerMetricsConstant.LABEL_PROCESSOR;
