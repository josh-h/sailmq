## Load Balancing
Load balancing in SailMQ is accomplished on Client side. Specifically, it can be divided into load balancing at Producer side when sending messages and load balancing at Consumer side when subscribing messages.

### Producer Load Balancing
When the Producer sends a message, it will first find the specified TopicPublishInfo according to Topic. After getting the routing information of TopicPublishInfo, the SailMQ client will select a queue (MessageQueue) from the messageQueue List in TopicPublishInfo  to send the message by default.Specific fault-tolerant strategies are defined in the MQFaultStrategy class.
...
![Image text](https://github.com/sail/sailmq/raw/develop/docs/cn/image/sailmq_design_8.png)
...
![Image text](https://github.com/sail/sailmq/raw/develop/docs/cn/image/sailmq_design_9.png)
