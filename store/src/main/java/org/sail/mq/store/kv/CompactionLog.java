...
import org.sail.mq.store.AppendMessageStatus;
import org.sail.mq.store.CompactionAppendMsgCallback;
...
import org.sail.mq.store.queue.BatchConsumeQueue;
import org.sail.mq.store.queue.CqUnit;
import org.sail.mq.store.queue.ReferredIterator;
import org.sail.mq.store.queue.SparseConsumeQueue;
...
import static org.sail.mq.common.message.MessageDecoder.BLANK_MAGIC_CODE;
