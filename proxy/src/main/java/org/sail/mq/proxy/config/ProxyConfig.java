...
package org.sail.mq.proxy.config;
...
public class ProxyConfig implements ConfigFile {
    ...
    private String tlsKeyPath = ConfigurationManager.getProxyHome() + "/conf/tls/sailmq.key";
    private String tlsCertPath = ConfigurationManager.getProxyHome() + "/conf/tls/sailmq.crt";
    /**
     * gRPC
     */
